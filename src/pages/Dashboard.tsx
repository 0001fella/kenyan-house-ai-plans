      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-2">
            <h1 className="text-2xl font-bold text-gray-900">Create Your Dream Home</h1>
            ...
            <Card className="shadow-lg border-0">
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  {currentStep === 1 && <><DollarSign className="h-5 w-5 text-blue-600" /> <span>Budget & Location</span></>}
                ...
                <CardDescription>
                  {currentStep === 1 && "Let's start with your budget and property details"}
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex justify-between pt-6">
                  ...
                  >
                    {currentStep === 3 ? "Generate Designs" : "Continue"}
